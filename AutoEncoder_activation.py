...
output_dir = "/infodev1/non-phi-data/junjiang/OvaryCancer/AutoEncoder_activation"

encoder_model = create_encoder()
# model_AE = create_model()
# Extracts the outputs of the top 12 layers
layer_outputs = [layer.output for layer in encoder_model.layers]
# Creates a model that will return these outputs, given the model input
activation_model = Model(inputs=encoder_model.input, outputs=layer_outputs)
